#!/bin/bash
wineconsole "AMPS/Includer.exe" ASM68K AMPS AMPS/.Data
...
cat out.log
wineconsole "AMPS\Dual PCM Compress.exe" "AMPS\.z80" "AMPS\.z80.dat" "Sonic_Selenium_1.gen" "_dlls\salvador.exe"
