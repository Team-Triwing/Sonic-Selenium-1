...
; ---------------------------------------------------------------
	...
	include	'error/Symbols.asm'
	include	'error/Formatter - Hex.asm'
	include	'error/Formatter - Bin.asm'
	include	'error/Formatter - Dec.asm'
	include	'error/Formatter - Sym.asm'
	include	'error/Formatter - Asm.asm'
	include	'error/Format String.asm'
	include	'error/Console.asm'
	include	'error/1bpp - Decompress.asm'
	include	'error/Decode.asm'
; ---------------------------------------------------------------
